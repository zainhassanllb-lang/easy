...
export const mockWorkers: Worker[] = [
  {
    ...
    about:
      "Experienced electrician with 8 years of professional service. Specialized in residential and commercial electrical work.",
    cnicNumber: "42101-1234567-1",
    cnicImages: [],
    selfieImage: "/placeholder.svg",
    isVerified: true,
    isActive: true,
    profileImage: "/professional-electrician-portrait.jpg",
    packageType: "premium",
    packageExpiry: new Date(Date.now() + 15 * 24 * 60 * 60 * 1000),
  ...
  },
  {
    ...
    category: "plumber",
    experience: 5,
    skills: ["Pipe Installation", "Leak Repair", "Drainage", "Water Heater"],
    about: "Professional plumber providing quality service for 5 years. Available for emergency repairs.",
    cnicNumber: "42101-7654321-1",
    cnicImages: [],
    selfieImage: "/placeholder.svg",
    isVerified: true,
    isActive: true,
    profileImage: "/professional-plumber-portrait.png",
    packageType: "standard",
    packageExpiry: new Date(Date.now() + 20 * 24 * 60 * 60 * 1000),
    hasPurchasedPackage: true,
    paymentProof: null,
    paymentStatus: "verified",
    profileViews: 189,
  ...
  },
  {
    ...
    category: "carpenter",
    experience: 10,
    skills: ["Furniture Making", "Door Installation", "Cabinet Work", "Repair"],
    about: "Master carpenter with over 10 years experience in custom furniture and woodwork.",
    cnicNumber: "35202-1111111-1",
    cnicImages: [],
    selfieImage: "/placeholder.svg",
    isVerified: true,
    isActive: true,
    profileImage: "/professional-carpenter-portrait.png",
    packageType: "premium",
  ...
  },
  {
    ...
    category: "painter",
    experience: 6,
    skills: ["Interior Painting", "Exterior Painting", "Texture", "Wallpaper"],
    about: "Professional painter specializing in both interior and exterior projects with attention to detail.",
    cnicNumber: "42101-2222222-1",
    cnicImages: [],
    selfieImage: "/placeholder.svg",
    isVerified: true,
    isActive: true,
    profileImage: "/professional-painter-portrait.png",
    packageType: "basic",
    packageExpiry: new Date(Date.now() - 5 * 24 * 60 * 60 * 1000),
    hasPurchasedPackage: true,
    paymentProof: null,
    paymentStatus: "verified",
    profileViews: 156,
  ...
  },
  {
    ...
    whatsapp: "+92 321 4444444",
    city: "islamabad",
    locality: ["f-7"],
    category: "ac-technician",
    experience: 7,
    skills: ["AC Installation", "AC Repair", "Maintenance", "Gas Filling"],
    about: "Certified AC technician with 7 years experience. Fast and reliable service.",
    cnicNumber: "61101-3333333-1",
    cnicImages: [],
    selfieImage: "/placeholder.svg",
    isVerified: true,
    isActive: true,
    profileImage: "/professional-ac-technician-portrait.jpg",
    packageType: "standard",
    packageExpiry: new Date(Date.now() + 18 * 24 * 60 * 60 * 1000),
    hasPurchasedPackage: true,
    paymentProof: null,
    paymentStatus: "verified",
    profileViews: 201,
