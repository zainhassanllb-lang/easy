  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 container mx-auto px-4 text-center">
        <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold text-white mb-6 text-balance">{title}</h1>
        {description && (
          <p className="text-xl md:text-2xl text-white/95 max-w-3xl mx-auto text-balance">{description}</p>
        )}
